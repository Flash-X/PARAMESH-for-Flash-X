...
!!        The local ID of the block to restrict into.
!!
...
!! RETURNS
!!
!!   Does not return anything.  Upon exit, data has been restricted from the
!!   children of block lb to the permanent data for lb in unk and so on.
!!
!! DESCRIPTION
!!
...
!!   This is a true '1blk' version, acting only on the block whose ID
!!   is passed in as lb, which is assumed to have children.
!!
...
!!REORDER(4): temp, sendf, send, tempf, tempn
